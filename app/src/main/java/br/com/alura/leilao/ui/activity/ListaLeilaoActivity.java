...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume ();
        atualizadorDeLeiloes.buscaLeiloes ( this.adapter, this.client, new AtualizadorDeLeiloes.ErroCarregaLeiloesListener () {
            @Override
            public void erroAoCarregar(String mensagem) {
                ListaLeilaoActivity.this.mostraMensagemDeFalha ( mensagem );
            }
        } );
    }
    ...
    public void mostraMensagemDeFalha(String mensagem) {
        Toast.makeText ( this,
                MENSAGEM_AVISO_FALHA_AO_CARREGAR_LEILOES + mensagem,
